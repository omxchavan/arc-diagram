            ...
            {nodes.length > 0 && (
                <div className="absolute top-6 right-6 z-10 flex gap-2">
                    <button
                        ...
                        className="p-2.5 rounded-xl bg-[#16161f]/80 backdrop-blur-md border border-white/10 text-white shadow-2xl hover:bg-[#1c1c28] transition-all group"
                        title="Fit View"
                    >
                    ...
                    <button
                        onClick={() => useDiagramStore.getState().autoLayout()}
                        className="p-2.5 rounded-xl bg-[#16161f]/80 backdrop-blur-md border border-white/10 text-white shadow-2xl hover:bg-[#1c1c28] transition-all group"
                        title="Auto Layout"
                    >
                        <svg className="w-5 h-5 opacity-70 group-hover:opacity-100" fill="none" stroke="currentColor" viewBox="0 0 24 24">
